...
static unsigned int clkdiv_cpu1_4412[CPUFREQ_LEVEL_END][3] = {
	...
	/* ARM L9: 900MHz */
	{ 3, 0 },{ 1425000, 1425000, 1425000, 1425000, 1412500, 1412500,	1400000, 1387500, 1375000, 1362500, 1350000, 1337500 },
};

static unsigned int exynos4x12_apll_pms_table[CPUFREQ_LEVEL_END] = {
        /* APLL FOUT L0: 1804MHz */
	((223<<16)|(3<<8)|(0x0)),
...
static const unsigned int asv_voltage_step_12_5[CPUFREQ_LEVEL_END][13] = {
	/*   ASV0,    ASV1,    ASV2,    ASV3,	 ASV4,	  ASV5,	   ASV6,    ASV7,    ASV8,    ASV9,   ASV10,   ASV11 */
	{ 1500000, 1500000, 1500000, 1500000, 1412500, 1412500,	1400000, 1387500, 1375000, 1362500, 1350000, 1337500 },
